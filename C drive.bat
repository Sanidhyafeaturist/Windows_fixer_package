...
chkdsk C: /f /r
echo chkdsk completed. The computer will not automatically restart.
echo.
echo To complete the repair, please restart your computer manually.
pause
goto menu
...
wmic logicaldisk get caption, drivetype > "%userprofile%\desktop\drives.txt"
echo Results saved to "drives.txt" on your desktop.
pause
goto menu
